...
#define SKYHALO_LED_PIN    7
#define MODE_INPUT_PIN A0

////////// STRIP CONSTANTS/VARS //////////

#define BACKSPLASH_NUM_LEDS 84
#define SKYHALO_NUM_LEDS    150 // TODO update when skyhalo is installed

#define NUM_STRIPS 2
#define LARGEST_STRIP_NUM_LEDS 150

const int NUM_LEDS[NUM_STRIPS] { BACKSPLASH_NUM_LEDS,
                                 SKYHALO_NUM_LEDS };
